// Edited to add fading animation
// Not minimizing for now until story is closed
    ...
    function Carousel(root, options) {
        ...
        function setPager(oEvent) {
            if ($(this).hasClass('pagenum')) {
                oSelf.move(parseInt($(this).attr('data-page')), true);
            }
            return false;
        };
        ...
        this.move = function (iDirection, bPublic) {
            ...
            if (iCurrent > -1 && iCurrent < iSteps) {
                ...
                if (options.animation == false && options.fading == true) {

                  oContent.fadeOut((options.fade_duration / 2), function() {
                    $(this).animate(oPosition, {
                      duration: 0,
                      complete: function () {

                        setButtons();
                        $(this).fadeIn(options.fade_duration)
